...
public class CustomerLoginRegisterActivity extends AppCompatActivity
{
    ...
    private TextView ihaveacofcustomers;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ihaveacofcustomers = (TextView)findViewById(R.id.ihaveacofcustomer);
        ...
        CreateCustomerAccount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                ihaveacofcustomers.setVisibility(View.VISIBLE);
            }
        });
        ihaveacofcustomers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                ihaveacofcustomers.setVisibility(View.INVISIBLE);
            }
        });
        ...
        RegisterCustomerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                String emails = CustomerEmail.getText().toString();
                    ...
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task)
                        {
                            ...
                            else
                            {
                                ...
                                Toast.makeText(CustomerLoginRegisterActivity.this, "Error : "+message, Toast.LENGTH_SHORT).show();
